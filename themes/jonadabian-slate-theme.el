...
(custom-theme-set-faces
 ...
 ;; rainbow-delimiters による括弧の色設定（派手な色に変更）
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#A39DFF" :weight bold)))) ;; Vibrant Lavender
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#7CD3C5" :weight bold)))) ;; Fresh Mint
 '(rainbow-delimiters-depth-3-face ((t (:foreground "#6FA8D9" :weight bold)))) ;; Bright Sky Blue
 '(rainbow-delimiters-depth-4-face ((t (:foreground "#E1AC5C" :weight bold)))) ;; Warm Golden Yellow
 '(rainbow-delimiters-depth-5-face ((t (:foreground "#A4C87A" :weight bold)))) ;; Soft Grass Green
 '(rainbow-delimiters-depth-6-face ((t (:foreground "#F9C6A0" :weight bold)))) ;; Peachy Orange
 '(rainbow-delimiters-depth-7-face ((t (:foreground "#FFCC4D" :weight bold)))) ;; Bright Yellow
 '(rainbow-delimiters-depth-8-face ((t (:foreground "#E4746A" :weight bold)))) ;; Coral Red
 '(rainbow-delimiters-depth-9-face ((t (:foreground "#B4D77A" :weight bold)))) ;; Light Lime Green

 ;; 括弧が足りない場合の強調表示（赤くする）
 '(show-paren-match-face ((t (:background "red" :foreground "white" :weight bold)))) ;; マッチした括弧
 '(show-paren-mismatch-face ((t (:background "darkred" :foreground "white" :weight bold)))) ;; 不一致な括弧
